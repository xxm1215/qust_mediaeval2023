...
def process(model, model_name):
    ...
    path = '/home/qd/PycharmProjects/MediaEval2022/RT-images-Test'
    ...
    if os.path.exists('RT4_image.pickle'):
        with open('RT4_image.pickle', 'rb') as f:
    ...
    with open('RT4_image.pickle', 'wb') as f:   # 使用
